  ...
  <section class="nomads-showcase-section">
    <div class="showcase-header">
      <div class="header-left">
        <h2 class="showcase-title">科学育儿与母婴照护专家实战模板库</h2>
...
const showcaseItems = computed<ShowcaseItem[]>(() => [
  {
    id: 'ai-muying-1',
    tag: '科学辅食',
    title: '6-8 个月宝宝初级辅食添加泥糊食谱',
    prompt: '设计 6-8 个月宝宝辅食食谱，包含高铁米粉、胡萝卜泥与三文鱼泥制作规范。',
    usageCount: '55.1k'
  },
  {
    id: 'ai-muying-2',
    tag: '肠胀气护理',
    title: '新生儿夜啼与肠胀气排气操 SOP',
    prompt: '剖析新生儿肠胀气原因，示范顺时针揉腹、飞机抱与拍嗝的标准手法。',
    usageCount: '49.8k'
  },
  {
    id: 'ai-muying-3',
    tag: '睡眠训练',
    title: '建立 4-6 个月宝宝吃玩睡作息规律',
    prompt: '制定 4-6 个月宝宝白天接奶与夜间接轨的作息时间表，建立睡眠仪式。',
    usageCount: '43.6k'
  },
  {
    id: 'ai-muying-4',
    tag: '发育评估',
    title: '1 岁宝宝大动作与语言发育测评',
    prompt: '评估 1 岁宝宝翻身、独坐、爬行及发音能力，提供促进发育的家庭游戏。',
    usageCount: '38.2k'
  },
  {
    id: 'ai-muying-5',
    tag: '月子餐营养',
    title: '产后 30 天四阶段月子餐科学搭配',
    prompt: '设计产后四周（排、调、补、养）月子餐指南，兼顾催乳与恢复身材。',
    usageCount: '33.9k'
  },
  {
    id: 'ai-muying-6',
    tag: '护理避雷',
    title: '新手爸妈高频育儿误区与避坑清单',
    prompt: '总结捏鼻梁、绑腿、早穿鞋等 10 个传统育儿误区，提供现代科学育儿替代。',
    usageCount: '29.5k'
  }
]);
