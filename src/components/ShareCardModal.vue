    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">科学育儿与母婴孕产</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 科学育儿与母婴孕产助手</span>
...
// 清理回复末尾的特殊标记 [MUYING_SCORES]...[/MUYING_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[MUYING_SCORES\][\s\S]*?\[\/MUYING_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 科学育儿与母婴孕产专家】\n\n${cleanContent.value}\n\n体验科学育儿AI助手：https://ai.wuxian.xyz`;
